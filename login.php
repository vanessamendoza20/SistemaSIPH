...
<html lang = "es">	<!--- Crea la pagina HTML principal y se le asigna el lenguaje español, se define la raíz del documento. --->
	...
	<head>	<!-- Colección de metadatos acerca de la página principal, incluye enlaces, scripts y hojas de estilo. -->
		...
		<link rel="stylesheet" type="text/css" href="css/loginn.css">	<!-- Enlaza JavaScript y CSS externos a la página principal -->
	...
	<body>	<!-- Inicia el cuerpo de la página -->
				...
				<div class="login-box">
				    ...
				    <form action="validar.php" method="POST">
						<div class="user-box">
							<p>Usuario</p>
							<br>
						<input type="text" placeholder="Ingrese clave de servipor público" name="usu" required>
						...
						<input class="btn btn-outline-info" type="submit" value="Ingresar">
						<p></p>
						<a class="btn btn-outline-light" href="registrarse.php">Registrarse</a>
				    </form>
				</div>
		...
		<footer class="titt">
			<h1>
				...
				<a href="https://twitter.com/SS_Edomex?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthorhttps://twitter.com" class="twi"><i class="bi bi-twitter"></i></a>
