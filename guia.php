...
<html lang = "es">	<!--- Crea la pagina HTML principal y se le asigna el lenguaje español, se define la raíz del documento. --->
	...
	<head>	<!-- Colección de metadatos acerca de la página principal, incluye enlaces, scripts y hojas de estilo. -->
		...
		<link rel="stylesheet" type="text/css" href="css/guia.css">	<!-- Enlaza JavaScript y CSS externos a la página principal -->
	...
	<body>	<!-- Inicia el cuerpo de la página -->
		...
		<!-- ------------------------------------------------------------ -->
			...
			<div class="calendario1">
				<iframe src="archivospdf/guia.pdf" type="application/pdf" class="cal"></iframe>
			</div>
        	...
        	<div class="image">
        		<a href="archivospdf/guia.pdf" download="Guía de Llenado del Informe Policial Homologado (Hecho Problemente Delictivo)" class="btn btn-outline-primary" ><i class="bi bi-arrow-bar-down"></i>Desgargar</a>
        	</div>
